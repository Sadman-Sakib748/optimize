...
export function MainFooter() {
  return (
    <footer className="bg-[#090A0C] pt-16 sm:pt-20 pb-12 sm:pb-16">
      {/* Main Footer Content */}
      <div className="px-4 sm:px-6 lg:px-12 border-b border-gray-800 pb-12 sm:pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col">
            <h1 className="text-4xl sm:text-5xl ml-10 md:text-2xl font-bold text-yellow-400 mb-4 sm:mb-6">
              OPTIMIZIFY
            </h1>
          ...
          {/* Company Links */}
          <div className="flex flex-col">
            <h3 className="text-lg sm:text-xl md:text-xl font-semibold text-yellow-400 mb-4 sm:mb-6">
              Company
            </h3>
