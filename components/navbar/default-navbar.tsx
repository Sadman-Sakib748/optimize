...
export function DefaultNavbar({
  ...
  return (
    <div
      ref={navRef}
      className="navbar-wrap w-full max-w-[100%] relative"
      style={{
        zIndex: 1000,
      }}
    >
        ...
        >
          ...
          >
            <span
              ...
              style={{
                background: "linear-gradient(45deg, #1b1811, #FFB800, #FFC727)",
              }}
            />
          ...
          >
            ...
            {/* Get Started */}
            <Link href="/register" className="navbar-cta ml-2 text-center">
              Get Started
            </Link>
          </div>
      ...
      {dropdown && dropdownEl && dropdownRect && (
        <div
          ...
          style={{
            ...
            background: "linear-gradient(195deg, #67b924, #43660b)",
            backdropFilter: "blur(20px) saturate(180%)",
            border: "1px solid rgba(255, 199, 39, 0.2)",
            boxShadow: "0 20px 60px rgba(20, 24, 2, 0.58), 0 0 0 1px rgba(255, 199, 39, 0.1)",
...
function DefaultNavbarMobileContent({
  ...
  return (
    <div
      ...
      style={{
        background: "linear-gradient(195deg, #3e7907, #21c20c)",
        backdropFilter: "blur(20px)",
        borderRadius: "16px",
        border: "1px solid rgba(255, 255, 255, 0.1)",
        boxShadow: "0 20px 40px rgba(22, 146, 22, 0.4)",
      }}
    >
      {routes.map((r) => (
        <div key={r.name}>
